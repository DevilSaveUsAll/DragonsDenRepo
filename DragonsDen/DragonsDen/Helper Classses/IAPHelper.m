...
- (void)buyProduct:(SKProduct *)product {
  ...
  if (payment) [[SKPaymentQueue defaultQueue] addPayment:payment];
    ...
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"iTunes Error" message:@"Error loading the iTunes store" delegate:self cancelButtonTitle:@"Ok" otherButtonTitles:nil, nil];
    [alert show];
  }
}
